...
public class NeApiClient {
     ...
     */
    public NeApiClient(HttpServletRequest request, HttpServletResponse response, String client_id, String client_secret, String redirect_uri) throws NeApiClientException {
        this._is_web = true;
    ...
    public NeApiClient(String access_token, String refresh_token) throws NeApiClientException {
        ...
        if (this._access_token == null) {
            throw new NeApiClientException("access_tokenは最後にapiExecute又はneLogin呼び出した後のgetAccessToken(),getRefreshToken()の戻り値を設定して下さい。");
        }
     ...
     */
    public HashMap<String, Object> apiExecute(String path, HashMap<String, String> api_params, String redirect_uri) throws IOException, NeApiClientException {
        this._redirect_uri = redirect_uri;
     ...
     * @throws NeApiClientException SDKの仕様方法が間違っている（path）等
     */
    public HashMap<String, Object> apiExecute(String path, HashMap<String, String> api_params) throws IOException, NeApiClientException {
        HashMap<String, Object> response;
     ...
     * @throws NeApiClientException SDKの仕様方法が間違っている（path）等
     */
    public HashMap<String, Object> apiExecute(String path, String redirect_uri) throws IOException, NeApiClientException {
        this._redirect_uri = redirect_uri;
    ...
    protected boolean responseCheck(HashMap<String, Object> response) throws IOException, NeApiClientException {
        ...
        if (result == null) throw new NeApiClientException("クライアントID・シークレットや指定したパスが正しいか確認して下さい。");
        if ( access_token != null ) this._access_token = access_token ;
        if ( refresh_token != null ) this._refresh_token = refresh_token ;

        // 正常終了
        if (result.equals(RESULT_SUCCESS)) return true;
